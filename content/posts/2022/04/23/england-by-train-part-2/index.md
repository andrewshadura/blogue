...
{{< figure "img-responsive" "error-error-error.jpeg" "Trainline, GWR and SNCF kept crashing" "Error messages at the websites of Trainline, GWR and SNCF"  >}}
...
{{< figure src="train-bratislava-cambridge.jpeg" class="img-responsive" alt="The map of the train route from Bratislava to Cambridge through Brussels and London" title="The complete route" caption="The complete route" >}}
...
P.S. The maps in this and other posts were created using [uMap](http://umap.openstreetmap.fr/en/); the map data come from [OpenStreetMap](https://openstreetmap.org/). The train route visualisation was generated with help of [signal.eu.org](https://signal.eu.org/osm/).

[1]: https://blog.shadura.me/2021/08/10/england-by-train-part-1/
