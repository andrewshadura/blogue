...
#               self.markdown.Meta = meta
            ...
            self.markdown.__class__.Meta = property(lambda self: self._Meta_data if hasattr(self, '_Meta_data') else {}, lambda self, value: self._Meta_data.update(value) if hasattr(self, '_Meta_data') else setattr(self, '_Meta_data', value))
            self.markdown.Meta = meta
